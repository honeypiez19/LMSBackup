        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="chief_dashboard.php"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="chief_leave.php">สถิติการลาและการมาสาย</a></li>
                            <li><a class="dropdown-item" href="chief_history.php">ประวัติการลาและการมาสาย</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="chief_leave_request.php">ใบลาของพนักงาน</a></li>
                            <li><a class="dropdown-item" href="chief_employee_leave.php">การลาของพนักงาน</a></li>
                            <li><a class="dropdown-item" href="chief_employee_attendance.php">พนักงานมาสาย</a>
                            </li>
                        </ul>
                    </li>
                </ul>
